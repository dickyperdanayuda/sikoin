...
<head>
  ...
  <title><?= $this->session->userdata("username"); ?> SIKOIN | Sistem Pengelolaan Kotak Infaq</title>
...
<body class="hold-transition sidebar-mini sidebar-collapse layout-fixed">
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-dark navbar-success">
      ...
      <!-- SEARCH FORM --
    <form class="form-inline ml-3" action="<?= base_url("Konten/search"); ?>" method="post">
      <div class="input-group input-group-sm">
        <input class="form-control form-control-navbar" name="cari_spm" id="cari_spm" type="search" placeholder="Cari Nomor SPM" value="<?= isset($cari) ? $cari : ""; ?>" aria-label="Search">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="" class="brand-link">
        ...
        <span class="brand-text font-weight-light">SIKOIN</span>
      </a>
      <!-- Sidebar -->
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <?php if ($this->session->userdata("level") < 3) { ?>
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item" style="padding-left: 20px;">
                    <a href="<?= base_url("Donatur/tampil") ?>" class="nav-link">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item" style="padding-left: 20px;">
                    <a href="<?= base_url("Karyawan/tampil") ?>" class="nav-link">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item" style="padding-left: 20px;">
                    <a href="<?= base_url("Kotak/tampil") ?>" class="nav-link">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item" style="padding-left: 20px;">
                    <a href="<?= base_url("Pecahan/tampil") ?>" class="nav-link">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item" style="padding-left: 20px;">
                    <a href="<?= base_url("Spesimen/tampil") ?>" class="nav-link">
              ...
              <li class="nav-item">
                <a href="<?= base_url("KotakMasuk/tampil") ?>" class="nav-link">
                  <i class="nav-icon fas fa-box"></i>
                  <p>
                    Kotak Masuk
                  </p>
              ...
              <li class="nav-item">
                <a href="<?= base_url("KotakKeluar/tampil") ?>" class="nav-link">
              ...
              <li class="nav-item">
                <a href="<?= base_url("PengambilanKwitansi/tampil") ?>" class="nav-link">
              ...
              <li class="nav-item">
                <a href="<?= base_url("Penugasan/tampil") ?>" class="nav-link">
            ...
            <?php } ?>
            <li class="nav-item">
              <a href="<?= base_url("Penjemputan/tampil") ?>" class="nav-link">
            ...
            <li class="nav-item">
              <a href="<?= base_url("Kwitansi/tampil") ?>" class="nav-link">
            ...
            <?php if ($this->session->userdata("level") < 3) { ?>
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item" style="padding-left: 20px;">
                    <a href="<?= base_url("LaporanRekap/tampil") ?>" class="nav-link">
                      <i class="nav-icon fas fa-file-alt"></i>
                      <p>
                        Laporan Rekap
                      </p>
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item" style="padding-left: 20px;">
                    <a href="<?= base_url("LaporanKwitansi/tampil") ?>" class="nav-link">
                      <i class="nav-icon fas fa-file-alt"></i>
                      <p>
                        Laporan Kwitansi
                      </p>
              ...
              <li class="nav-item">
                <a href="<?= base_url("History/tampil") ?>" class="nav-link">
          ...
          <div class="row mb-2">
            <div class="col-sm-12">
              <marquee style="background:white;border-radius:5px; color:black; " scrolldelay="1" scrollamount="3" direction="left">
                <b>SIKOIN - Sistem Pengelolaan Kotak Infaq</b> Donasi Rumah Tahfizh &copy; 2021.
              </marquee>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
