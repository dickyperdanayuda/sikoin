<?php
  class Model_Pengguna extends CI_Model {
  	...
  	var $table = 'ars_login';
	var $column_order = array('log_user'); //set column field database for datatable orderable
	var $column_search = array('log_user', "log_level"); //set column field database for datatable searchable just firstname , lastname , address are searchable
