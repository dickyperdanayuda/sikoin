...
class Model_Karyawan extends CI_Model
{
	...
	var $table = 'ktk_karyawan';
	var $column_order = array('kry_id', 'kry_nama', 'kry_jk', 'kry_telp', 'kry_wa', 'kry_alamat'); //set column field database for datatable orderable
	var $column_search = array('kry_nama', "kry_telp", "kry_alamat"); //set column field database for datatable searchable just firstname , lastname , address are searchable
	...
	public function cari_karyawan_bywa($wa)
	{
		$this->db->from("ktk_karyawan");
		$this->db->where("kry_telp", $wa);
		$query = $this->db->get();
